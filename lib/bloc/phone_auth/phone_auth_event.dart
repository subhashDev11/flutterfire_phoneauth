...
// This event will be triggered when if user pre-logged-in.
class PreLoggedInEvent extends PhoneAuthEvent {
  final User user;
  const PreLoggedInEvent({required this.user});

  @override
  List<Object> get props => [user];
}

// This event will be triggered when if user making logout.
